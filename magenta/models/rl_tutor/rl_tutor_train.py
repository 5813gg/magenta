...
tf.app.flags.DEFINE_string('output_dir', '/home/natasha/Dropbox/Google/SMILES-Project/output/prioritized_replay_512/',
                           'Directory where the model will save its'
                           'compositions and checkpoints (midi files)')
tf.app.flags.DEFINE_string('rnn_checkpoint_dir','/home/natasha/Dropbox/Google/SMILES-Project/models/smiles_rnn_512/',
