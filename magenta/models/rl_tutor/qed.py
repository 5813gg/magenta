"""Note to self: this library should be installed properly from 
http://silicos-it.be.s3-website-eu-west-1.amazonaws.com/software/biscu-it/qed/1.0.1/qed.html
but I couldn't get it working, so pasting it here is a hack."""
